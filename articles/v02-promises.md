...
[`daemons()`](https://mirai.r-lib.org/reference/daemons.md) to
...
> Call [`daemons()`](https://mirai.r-lib.org/reference/daemons.md) at
> top level. Use `onStop()` to automatically shut down daemons when the
> app exits.
...
2.  **Server**: Create ExtendedTask with `ExtendedTask$new()`, passing
    `...` to [`mirai()`](https://mirai.r-lib.org/reference/mirai.md),
    bind to button:
...
This integrates
[`mirai_map()`](https://mirai.r-lib.org/reference/mirai_map.md) into a
Shiny observer without ExtendedTask.
...
This uses
[`mirai_map()`](https://mirai.r-lib.org/reference/mirai_map.md) to
...
[`mirai()`](https://mirai.r-lib.org/reference/mirai.md) call directly).
...
collect_aio(res)
#> [[1]]
#> [1] "{\"time\":[\"2026-07-11 16:33:00\"],\"msg\":[\"1\"],\"pid\":[18653]}"
#> 
#> [[2]]
#> [1] "{\"time\":[\"2026-07-11 16:33:01\"],\"msg\":[\"2\"],\"pid\":[18671]}"
#> 
#> [[3]]
#> [1] "{\"time\":[\"2026-07-11 16:33:01\"],\"msg\":[\"3\"],\"pid\":[18655]}"
#> 
#> [[4]]
#> [1] "{\"time\":[\"2026-07-11 16:33:00\"],\"msg\":[\"4\"],\"pid\":[18671]}"
#> 
#> [[5]]
#> [1] "{\"time\":[\"2026-07-11 16:33:00\"],\"msg\":[\"5\"],\"pid\":[18655]}"
#> 
#> [[6]]
#> [1] "{\"time\":[\"2026-07-11 16:33:00\"],\"msg\":[\"6\"],\"pid\":[18665]}"
#> 
#> [[7]]
#> [1] "{\"time\":[\"2026-07-11 16:33:01\"],\"msg\":[\"7\"],\"pid\":[18653]}"
#> 
#> [[8]]
#> [1] "{\"time\":[\"2026-07-11 16:33:01\"],\"msg\":[\"8\"],\"pid\":[18665]}"
...
collect_aio(res)
#> [[1]]
#> [1] "{\"time\":[\"2026-07-11 16:33:05\"],\"msg\":[\"1\"],\"pid\":[18735]}"
#> 
#> [[2]]
#> [1] "{\"time\":[\"2026-07-11 16:33:05\"],\"msg\":[\"2\"],\"pid\":[18733]}"
#> 
#> [[3]]
#> [1] "{\"time\":[\"2026-07-11 16:33:05\"],\"msg\":[\"3\"],\"pid\":[18745]}"
#> 
#> [[4]]
#> [1] "{\"time\":[\"2026-07-11 16:33:05\"],\"msg\":[\"4\"],\"pid\":[18751]}"
#> 
#> [[5]]
#> [1] "{\"time\":[\"2026-07-11 16:33:06\"],\"msg\":[\"5\"],\"pid\":[18745]}"
#> 
#> [[6]]
#> [1] "{\"time\":[\"2026-07-11 16:33:06\"],\"msg\":[\"6\"],\"pid\":[18733]}"
#> 
#> [[7]]
#> [1] "{\"time\":[\"2026-07-11 16:33:06\"],\"msg\":[\"7\"],\"pid\":[18751]}"
#> 
#> [[8]]
#> [1] "{\"time\":[\"2026-07-11 16:33:06\"],\"msg\":[\"8\"],\"pid\":[18735]}"
