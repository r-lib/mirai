...
manual](https://mirai.r-lib.org/articles/v01-reference.md) for a
detailed introduction.

## Key Takeaways

- **[`mirai()`](https://mirai.r-lib.org/reference/mirai.md)** returns
  immediately, access result via `m[]` or `m$data`
- **[`daemons()`](https://mirai.r-lib.org/reference/daemons.md)** sets
