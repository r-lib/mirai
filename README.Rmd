...
We provide launchers for distributed computing that launch daemons over the network via SSH or HPC cluster resource managers including Slurm, SGE, Torque, PBS and LSF.
...
[<img alt="R parallel" src="https://www.r-project.org/logo/Rlogo.png" width="40" height="31" />](https://mirai.r-lib.org/articles/v5-parallel.html) &nbsp; Provides the first official alternative communications backend for R, implementing the 'MIRAI' parallel cluster type, a feature request by R-Core at R Project Sprint 2023.
