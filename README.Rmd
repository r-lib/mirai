...
- Modern networking and concurrency over IPC, TCP/IP and secure TLS connections
- Professional task queues and scheduling built on [nanonext](https://github.com/r-lib/nanonext/) and [NNG](https://github.com/nanomsg/nng/)
...
- Clear delineation of local and evaluation environments with explicit object passing
- Simplicity in user interface supports 100% transparent and robust operation
