...
See the [quick reference](https://mirai.r-lib.org/articles/mirai.html) for a full introduction.
...
[<img alt="R parallel" src="https://www.r-project.org/logo/Rlogo.png" width="40" height="31" />](https://mirai.r-lib.org/articles/v04-parallel.html) &nbsp; The first official alternative communications backend for R, a parallel cluster type.
...
[<img alt="tidymodels" src="https://www.tidymodels.org/images/tidymodels.png" width="40" height="46" />](https://tune.tidymodels.org/) &nbsp; Core parallel processing infrastructure provider for tidymodels.
...
[<img alt="Arrow" src="https://arrow.apache.org/img/arrow-logo_hex_black-txt_white-bg.png" width="40" height="46" />](https://mirai.r-lib.org/articles/v03-serialization.html) &nbsp; Query databases over ADBC connections natively in the Arrow data format.

[<img alt="Polars" src="https://github.com/pola-rs/polars-static/raw/master/logos/polars_logo_blue.svg" width="40" height="46" />](https://mirai.r-lib.org/articles/v03-serialization.html) &nbsp;Native handling of Polars objects across parallel processes via serialization hooks.

[<img alt="targets" src="https://github.com/ropensci/targets/raw/main/man/figures/logo.png" width="40" height="46" />](https://docs.ropensci.org/targets/) &nbsp; Powers targets pipelines via crew, a distributed worker launcher built on mirai.
