...
- Built on [nanonext](https://github.com/r-lib/nanonext/) and [NNG](https://nng.nanomsg.org/)
...
- A set of correct defaults ensures 100% transparent and deterministic results
