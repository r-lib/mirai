...
If the mirai was still in progress, it resolves immediately to an
...
Each [`mirai()`](https://mirai.r-lib.org/dev/reference/mirai.md) call
...
[`mirai()`](https://mirai.r-lib.org/dev/reference/mirai.md) calls block
...
[`mirai_map()`](https://mirai.r-lib.org/dev/reference/mirai_map.md) in a
