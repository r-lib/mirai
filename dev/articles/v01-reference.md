...
m[]
#> [1] 5.533764 3.076497 4.528152 4.900177 5.589737
m$data
#> [1] 5.533764 3.076497 4.528152 4.900177 5.589737
```
...
m1[]
#> [1] 5.891974 2.657598 5.031042 3.575616 4.359073
```
...
The `capacity` argument controls the maximum number of tasks at the
dispatcher; new tasks block until existing ones complete, providing
backpressure to prevent excessive memory usage. It also enables mirai
cancellation via
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.6.226:50616")'
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.6.226:50617")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.6.226:50618",tlscert=c("-----BEGIN CERTIFICATE-----
#> MIIFQTCCAymgAwIBAgIBATANBgkqhkiG9w0BAQsFADA4MRYwFAYDVQQDDA0xOTIu
#> MTY4LjYuMjI2MREwDwYDVQQKDAhOYW5vbmV4dDELMAkGA1UEBhMCSlAwHhcNMDEw
#> MTAxMDAwMDAwWhcNMzAxMjMxMjM1OTU5WjA4MRYwFAYDVQQDDA0xOTIuMTY4LjYu
#> MjI2MREwDwYDVQQKDAhOYW5vbmV4dDELMAkGA1UEBhMCSlAwggIiMA0GCSqGSIb3
#> DQEBAQUAA4ICDwAwggIKAoICAQCSe9SH0Kj1M8YLAtos2yk7kQK/WBGXVxt7AefQ
#> DCiRU/S8nTaRMLJi+roGwles1EU2lBwt7cUL1EbgV67dGCkpVwiv/dKTIc6Qejyg
#> CBgtlRQPp1AXuJgokGmEGGOzPhx/FWTzkH/UzJDzPJK4/KCrQgvSh78di7Lf9wkl
#> 0zO/lGXgMyU0oJ6u6f618YeP+VX9hW/vAbhrkibMmZEDWGi30yIFGF2C1FHhXUP0
#> R+2jQaZmqgzDimp2GTTtxcWSPe+YNnAbnIezikYWAddgTaikVSlos4/QGRg8u/zV
#> zgBmx9AlpedRybq2UxaEVY45Z+z7uvsykZtwGBLJuoVnLIEqz07u9OkyWl4HB88Y
#> 1PIfBvWh8jttLV9mE4mZ8rCYJCebHVT0I2c0RRyb/CiFxazaTpXSScFCzKXj2j2C
#> wzSAY/gwLSje5rb2239axcCmklJvklCH2vN8bUoBzNt6VM8cSn9x6rdn0C0LQ2Ud
#> jJ+HFhzlBAVSRfS2y5eV/51iYcyRN+J9dp1V7/VQFZt3e8b/mEjexEtssIRXK0HQ
#> 2nf48vWTQ6AdqvftPUaYyEshFHzDeNyqjR8V9O75sSTwabMrrTJjM1tnljkW0fA2
#> da+RPQWJbe+6c2O/lw1Utdn0gWgJZBgO6MY7Jb/elqqEG333YQb4Q/JWVqg/KpP4
#> 4BjC3QIDAQABo1YwVDASBgNVHRMBAf8ECDAGAQH/AgEAMB0GA1UdDgQWBBRLyBe/
#> 1MsN1yjlQpnKDnGwwGCrdTAfBgNVHSMEGDAWgBRLyBe/1MsN1yjlQpnKDnGwwGCr
#> dTANBgkqhkiG9w0BAQsFAAOCAgEAepX4g7tFsWCcgd0b2u8QrpMNvQnMUbA7M6Y/
#> ioSikPV+ygwoiF1SY1f0NXEOXRya5iel1PGYMXA75z5ZOohLH0QE9mnPD5m8X09B
#> GPt5ECzEXNcKZAJXYkYQf6fZTbxgEumZY9gdf8Asb5IQsx/YipUB9lyloih5LfuI
#> TfYqYOTH/QJXNvmHNunPz9SlUVkqeIb0f+jdz9NJNt7D7T5fpHoOaavQ83AzxQIy
#> BunW3kYHt2RGitWWwM5vupA4WZ3q6MM+FF5effsz89dyDIDLQNmvroDFp/fmpCwc
#> 5jYer2NRhhlusGV7aqDB3s6iaOvFea8sOQj1MkuNBgEg1L80kNNircWrTv0vQYpG
#> b8MVwc3OnBOtgirgeUnM/3j+1fJJiYSuLl+42dQfMuTXaeQTG0l6cMnTJ+MJMDCf
#> zjCx5ghZSWkgOq2lT5AAhG7FX/ujoWfDUCxLdMeLRnMuDlovieRT26dliFV4S7t2
#> TrhUsAAp50PTaYCj/CB+MuDfjz4qkYIc9Cgq71g2vKpJRDIkUXRaIDLkGpn+MFqL
#> W1dUA2P9/ourSRwlhAMm7PmefzDnyJ/YGfrcnymhqRyazeKC2+C/JYm5Uc9qf+8F
#> Ez3qPtTkELyqKvlfKI9Ev66taGXLIfSmxP0XS20Clk4xit0gi2CkbKcSV2+st9IW
#> JUJu5F8=
#> -----END CERTIFICATE-----
#> ",""))'
```
