...
> This explicit design perfectly matches message-passing parallelism - attempting to infer global variables would introduce unreliability, which we do not compromise on.
