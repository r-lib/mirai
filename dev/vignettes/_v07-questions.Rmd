...
Automatic globals detection is an imperfect abstraction that can easily lead to sending more than required to other processes hence slowing things down, as well as unpredictable edge cases.
