...
host_url()
#>                 eth0              docker0 
#>  "tcp://10.1.0.46:0" "tcp://172.17.0.1:0" 
host_url(tls = TRUE)
#>                     eth0                  docker0 
#>  "tls+tcp://10.1.0.46:0" "tls+tcp://172.17.0.1:0" 
host_url(tls = TRUE, port = 5555)
#>                        eth0                     docker0 
#>  "tls+tcp://10.1.0.46:5555" "tls+tcp://172.17.0.1:5555" 

local_url()
#> [1] "abstract://5e5c9d5b524d8a3553602748"
local_url(tcp = TRUE)
#> [1] "tcp://127.0.0.1:0"
