...
- ...:
  ...
  including `asyncdial`, `autoexit`, `cleanup`, `output`, `maxtasks`,
  `idletime`, and `walltime`. Overrides arguments from
  [`daemons()`](https://mirai.r-lib.org/dev/reference/daemons.md) if
  supplied.
