...
- url:
  ...
  (character) host URL for remote nodes to dial into, e.g.
...
generated by
[`remote_config()`](https://mirai.r-lib.org/reference/remote_config.md)
or [`ssh_config()`](https://mirai.r-lib.org/reference/ssh_config.md). In
this case, the number of nodes is inferred from the configuration
