...
- data:
  ...
  [`mirai::daemon()`](https://mirai.r-lib.org/reference/daemon.md) call
...
[`mirai::daemon()`](https://mirai.r-lib.org/reference/daemon.md) call,
e.g. `mirai::daemon("tcp://10.0.0.7:34291")` (when using TLS, the
...
#> function () 
#> pwb_headers()
#> <bytecode: 0x559cace74f50>
#> <environment: namespace:mirai>
#> 
#> $data
#> function (...) 
#> pwb_data(...)
#> <bytecode: 0x559cace748c0>
#> <environment: namespace:mirai>
#> 
#> $dots
#> list()
