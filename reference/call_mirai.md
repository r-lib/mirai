...
[`mirai_map()`](https://mirai.r-lib.org/reference/mirai_map.md), as well
as individual 'mirai'.
...
Using [`unresolved()`](https://mirai.r-lib.org/reference/unresolved.md)
on a 'mirai' returns TRUE only if it has yet to resolve and FALSE
...
[`race_mirai()`](https://mirai.r-lib.org/reference/race_mirai.md) to
