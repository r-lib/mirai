...
argument of [`daemon()`](https://mirai.r-lib.org/reference/daemon.md)),
or else NULL if a stream has not yet been created.
...
[`daemon()`](https://mirai.r-lib.org/reference/daemon.md) processes.
...
nextget("url")
#> [1] "abstract://f8a708cae998682335472fde"
