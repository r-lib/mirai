...
test_error(mirai_map(1:2, identity), "No daemons set")
test_error(daemons(url = "URL"), "Invalid argument")
test_error(daemons(-1), "zero or greater")
test_error(daemons(raw(0L)), "must be numeric")
test_error(daemons(1, dispatcher = 1L), "should be either TRUE or FALSE")
test_error(daemons(url = local_url(), dispatcher = 0), "should be either TRUE or FALSE")
...
test_error(require_daemons(), "No daemons set")
test_error(mirai:::stop_d(), "No daemons set")
