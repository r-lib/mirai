...
The effect is additive, and does not remove any previously-registered functions.

4. `nextget()`, for querying values for a compute profile, such as 'urls', described in the function's documentation. Note: only the specifically-documented values are supported interfaces.
