...
#> 
#> $daemons
#> [1] "abstract://6f00be6c1a9c6d6d400cace8"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "abstract://fc14c9199ce2c107d7b93265"
```
...
launch_remote(2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.1.71:41701")'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://192.168.1.71:41701")'
daemons(0)
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.1.71:36015",tls=c("-----BEGIN CERTIFICATE-----
...
#> AQEFAAOCAg8AMIICCgKCAgEAsgsUV7lze0bVrhB53HTB1bK9NBSgv3MVmd+gIsPI
#> wQ/EStPbJ5M6J7QR5g6XKFGcgWUIAcLARx1lg5xBATYeZA+mLoKObipe313x8Ebb
#> XE9PU8b3pmWOhsP9Wd5R6Tbjeko8cEegRA8E/bmL++0mGUK/0zcBXmjndjs4D5Iy
#> OjVeL3iE8uUsqC/8/Q4kg9vR61kkA/MT+tjHYIMwjV/VgG3OJgQQWxH3eRCdrPkJ
#> QraxsT5GC2fc/mZm/VUyglVLBCEmfC1brBlTGaymnHaXdJvohhAqS9pgRuVeVbQP
#> 3HR9J95ejNaz9xcQaea5/cPVXcqrYBWPHK41ctZ/EiQTpM9P1HC7nafQp8Qq1azI
#> UbGhUOq/QpmnnbnVH1aRx8LjWni/p9B0nO5wsssSpyJfmtGbcBMYo0/ZvTMXdRc0
#> R6eJGb1IrM/FEZFUEshrRCTjCZwf2gHhwU+tGAAXI9plutetOitxLi0XuTRDGmlC
#> rF2DWXGdxBYrVYvQWz6rFW/VCk8gK8iN1I9dP7jEAJbv4x8jAcyTByQ4rRNCvWp/
#> zJ7zrT4ibWSwNJOi3KcTmv8d5hJ98nvj5QhgiY5MYota5aM9QNn/KC2L8rgdbUpD
#> uCKc8N/pOkykKOdTPnGlRxBpuewyXEmuWgoC+RRwh0rsKM1DWjMB/lVBEUou/FGl
#> a/cCAwEAAaNWMFQwEgYDVR0TAQH/BAgwBgEB/wIBADAdBgNVHQ4EFgQUkcNg/pPN
#> H29MuyI6iYq+emArXUIwHwYDVR0jBBgwFoAUkcNg/pPNH29MuyI6iYq+emArXUIw
#> DQYJKoZIhvcNAQELBQADggIBACOAaKqJBDSU4awmsS3v6Vr6/X55jmMw81kgtr6K
#> 6v4WHK5O2SZKHZCN4gzaXig8L3uKmgB3zyzbR+t+owgWdk3IstCldVX1sxMq7cNP
#> TFYx84Go887YRq3NYPfHdjYUPWgsRs/birgHCdslH+WGLwUmqTEeua9ydzgd5xP4
#> Y6JUEOywH0BSpwAKB+dVZJu+qzhFGN/gCUhuX4+ptWAqW6AVNSt7zUcszsgYLpAf
#> 9gFZWMnGtX6nNHZz86mWe0HFpfQZ3Z7WEYiF0xJJK7QEQpUeMxZF7GJX04MKvEnQ
#> PXNVSaEtO1jgno3ToxhwjTcYaUubwSaxNAJFFrLuobO/FlHZsH/PUNWoRbZlCKzq
#> MelQzUos1NRh3KsL1e344Hx8JOq4oRgtnje8RBojuOa8VOoLRQpVr8bUMUFiFMwI
#> hSZW90zXrhFuKoZVMj6euYtNlA+w3U21YiKKfeeihFiFDyalshw/lCvFEv1PS63u
#> NrJwSrPfaE4g6Rs9Cw0LBYt6nGK7fTqnNA4wzzZULUSnss58hSwk6BJmrHawpRYa
#> YTPsrd6bf8+BiGcaYHDfhllt4tPRKpaR3kSx5Kq7Hw+z3jtEW5b6I1gg3hlnpQbn
#> 6OBAe4KrodTqGrE0tjesan/NTdHK1o1+4IRpgGneWKg0MpC+7CVnfZYhb8WLKmPi
#> KzvN
#> -----END CERTIFICATE-----
#> ",""))'
```
