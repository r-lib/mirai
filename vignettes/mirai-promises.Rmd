...
``` r
library(mirai)
daemons(12, dispatcher = FALSE)
#> [1] 12
r <- 0
start <- Sys.time()
m <- mirai_map(1:10000, \(x) x, .promise = \(x) r <<- r + x)
Sys.time() - start
#> Time difference of 1.893664 secs
later::run_now()
r
#> [1] 50005000
daemons(0)
#> [1] 0
```
The one million promises challenge took 5 mins 5 secs to complete using an Apple M4 Pro MacBook.
...
collect_aio(res)
#> [[1]]
#> [1] "{\"time\":[\"2025-07-11 17:06:01\"],\"msg\":[\"1\"],\"pid\":[12163]}"
#> 
#> [[2]]
#> [1] "{\"time\":[\"2025-07-11 17:06:01\"],\"msg\":[\"2\"],\"pid\":[12165]}"
#> 
#> [[3]]
#> [1] "{\"time\":[\"2025-07-11 17:06:01\"],\"msg\":[\"3\"],\"pid\":[12175]}"
#> 
#> [[4]]
#> [1] "{\"time\":[\"2025-07-11 17:06:02\"],\"msg\":[\"4\"],\"pid\":[12163]}"
#> 
#> [[5]]
#> [1] "{\"time\":[\"2025-07-11 17:06:01\"],\"msg\":[\"5\"],\"pid\":[12185]}"
#> 
#> [[6]]
#> [1] "{\"time\":[\"2025-07-11 17:06:02\"],\"msg\":[\"6\"],\"pid\":[12185]}"
#> 
#> [[7]]
#> [1] "{\"time\":[\"2025-07-11 17:06:02\"],\"msg\":[\"7\"],\"pid\":[12165]}"
#> 
#> [[8]]
#> [1] "{\"time\":[\"2025-07-11 17:06:02\"],\"msg\":[\"8\"],\"pid\":[12175]}"
...
collect_aio(res)
#> [[1]]
#> [1] "{\"time\":[\"2025-07-11 17:06:06\"],\"msg\":[\"1\"],\"pid\":[12238]}"
#> 
#> [[2]]
#> [1] "{\"time\":[\"2025-07-11 17:06:06\"],\"msg\":[\"2\"],\"pid\":[12240]}"
#> 
#> [[3]]
#> [1] "{\"time\":[\"2025-07-11 17:06:06\"],\"msg\":[\"3\"],\"pid\":[12256]}"
#> 
#> [[4]]
#> [1] "{\"time\":[\"2025-07-11 17:06:06\"],\"msg\":[\"4\"],\"pid\":[12250]}"
#> 
#> [[5]]
#> [1] "{\"time\":[\"2025-07-11 17:06:07\"],\"msg\":[\"5\"],\"pid\":[12240]}"
#> 
#> [[6]]
#> [1] "{\"time\":[\"2025-07-11 17:06:07\"],\"msg\":[\"6\"],\"pid\":[12238]}"
#> 
#> [[7]]
#> [1] "{\"time\":[\"2025-07-11 17:06:07\"],\"msg\":[\"7\"],\"pid\":[12256]}"
#> 
#> [[8]]
#> [1] "{\"time\":[\"2025-07-11 17:06:07\"],\"msg\":[\"8\"],\"pid\":[12250]}"
