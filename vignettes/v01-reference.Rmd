...
> This is a 100% reliable evaluation model that corresponds to the underlying implementation - any attempt to abstract away from it is inherently imperfect, and we do not compromise on this point.
...
m[]
#> [1] 3.619994 5.039846 2.795265 6.013771 5.759041
m$data
#> [1] 3.619994 5.039846 2.795265 6.013771 5.759041
```
...
m1[]
#> [1] 2.528497 3.967952 4.445170 3.847297 3.851531
```
...
#> 
#> $daemons
#> [1] "ipc:///tmp/0968a70faa6f2659ef5e2d22"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "ipc:///tmp/d6f460e68e5e91bfece85875"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.1.110:54432")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.1.110:54433",tlscert=c("-----BEGIN CERTIFICATE-----
...
#> DQEBAQUAA4ICDwAwggIKAoICAQDIQ8kPzY7F6NX4fVic6a3iIj54zo6sRqTWv2Wn
#> qz2ZNnbpTEANdlWc/cO8CJ57PsrzWLPCFBrzBrAr3Pz4nNb+Nbo9jmGJmdlFV2XM
#> q7af+D9xlC5TBoh5GZ9qdF/RC+c8SOdlXlsDsT9hFQXUYf3Vm5Wl5SF7T5CkdXSf
#> jubBmOQz0KdQESOe4XuuZ+IJOV20LiuTsUJZ1o4ehI1Zkh7BBtUexOZKWBIN0KS3
#> qdnrg6NhjKtsx2CaTeKMJPjNIKcveO0Y83YdLenJFD9rQ6J/GZebK5/Q9tec73qe
#> DPamEJUDm7BaPff9pKa0CGdByptbyeWdToe5nkRXxrbwDoMUIFH9NhsBZGMp5w/y
#> 75JXqOuAtJQWH4pTbIM92dfvToeSnMGiOrXEGxl7Hk5jb7fckIgnvWnp2pcbvsEw
#> +W5PDYdv+2pPVNTKAI78t80nCd+n6775TMJRajOIttSWEs9cswpWa24WrtMKZlGi
#> vAEWzxqpJuyUN+R8ikxKOmbG3yd+y3XFizns5Hh1aqCA908HGfB7oGyFvULV2hn2
#> 3m9bEd3arMVLtu1V8QQ83c0N2QOC01b9NeGOANBzLt0TWh7R94qH9wNAu65mOHp9
#> x2eIZrk7xrDBs/cJeAb/Ge3TawobnNFUvHxhnQsPbzEA8HFdhMsXvQh5Xi6mrH5a
#> zVzIlwIDAQABo1YwVDASBgNVHRMBAf8ECDAGAQH/AgEAMB0GA1UdDgQWBBSEUciY
#> s5z1OxJ83RJ3eg5e6qPIDzAfBgNVHSMEGDAWgBSEUciYs5z1OxJ83RJ3eg5e6qPI
#> DzANBgkqhkiG9w0BAQsFAAOCAgEArquj0sI/DQbdl5LUbCHoDOjGJcyprGJTSiYr
#> xJsmRQuKtEurE7OCf8tAM5e2JH3qFUnM45R6lvINz1OBYGh5sM2fhYgiefIpbC+s
#> pQdrMRjEQj3Gj1SMV8spVZnw32W3POQBxXaZaP+ply1ioscq1iMoaakpN59fTi0J
#> QLMNze0/kQwSeiSO0DCIgoL87esRSNFV22jLNrY8bGEIHgFjAUepkDQMuqJbmc19
#> 21NrkECHZ2MNaVpnI2dgljzgLgAXlA43xiT2KsuCDO0Xd5NOFyy3Tr1fXG6ofbWT
#> tQdmSJEsXDof2V7TxqFKPepx6vIlXtWpvMFO793oOi2CuC2EJu+SKnDLG238KDdC
#> WO1qE8vh1DxTvdLJ8TFzJ/xAD90+znF+2U23U1tytlzYWz685GlTHYiV1OjNFpzk
#> KWZRsZ8fx+keQv/ePRZquFsSWtvhIH5DLbfK3ZfLTbDalxQB7XiMDtQiekvSjVCx
#> iERDL/laqEFn1R5d7zZwPBDHgGLmnuVNVMKXkuK/46ebQqtlagdvZnz00HL8A8iI
#> DdqwcTphfDouqseALuw4nrvUH2vvyH9Vv/byz94KJiRVvhxCDRZU+sB3+mp2grBC
#> NbSTmg1FXdYz5M4/UqENMNDde3weqfLCZkgzpCSNKanGrbxj1xMXHISRbevXKgqN
#> OlYItf8=
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "ipc:///tmp/20fc1d138583a78172589efa"
m1[]
#> [1] 68006

s2$daemons
#> [1] "ipc:///tmp/b63267bc4ab30b0c6469ff51"
m2[] # different to m1
#> [1] 68032
