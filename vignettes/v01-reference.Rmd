...
The `capacity` argument controls the maximum number of tasks at the dispatcher; new tasks block until existing ones complete, providing backpressure to prevent excessive memory usage.
