...
m[]
#> [1] 4.607727 4.992878 3.953911 3.908682 4.023580
m$data
#> [1] 4.607727 4.992878 3.953911 3.908682 4.023580
```
...
m1[]
#> [1] 2.242510 4.504102 3.395497 4.191759 3.076361
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.7.113:53593")'
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.7.113:53594")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.7.113:53595",tlscert=c("-----BEGIN CERTIFICATE-----
...
#> DQEBAQUAA4ICDwAwggIKAoICAQCqTsTpq02Tml98MdjGT5c+Gj4o/q6z/BZa/2bH
#> bsrMI5oSvzSfTLcpytEJxU9Oh3P4fqZXu4XfHUkdttonvaTCzRfiG6StWtpy7IdS
#> BXBqfHB/3UjucyZBp1FGVT41r/XCza7qJI/JRm+XJB6zhDGzUJepDjk4yns9AgVq
#> HBPv4XSoPf3XWp8zhie7vKih6TRMCAS6QLkJfUIt12PY/756n2bzJQ4rsy3SwfK5
#> 5YZc6LUIAfui6+HdzfjS3aWK5k1fD6TTYuGKPV1eUSrC0seX/9sdPI/F2GTx5PQE
#> rgv/N5eJ/WU1HAy4WYHLdHUDMJSY0m8Z1vrB2wSelddM06osRY4vw/rLSXjMQzmy
#> JH/wYTfAgCGRWa65/j3DkMLUy9iiX51VH38kl7YYFll1s/P1SzU78X2Sv3IV+j/v
#> L0wZOcoLUkL/MS4w47L3brsIAaDlN4BubySDOuZ1VXmCBZw5nJrFbT/j3ARDXny3
#> ZxTfEnxKAUXNBEYZr/6xruv0T01ePB2LP0NghTR4I3aKFQAfeRaHipMn+fqhEM8s
#> ZkHDQt4qVD4tdc2OmYPKS8+4ocSN5j5ukCIl9Hf4IzIHQDyGDBcHOZ31sJlNlODU
#> tfkP26169LFooVwE/+GzT10w0yUUzp/zbwvZiamUZau/Jrkq5ezhIgsJvTA3scxQ
#> VVNZrQIDAQABo1YwVDASBgNVHRMBAf8ECDAGAQH/AgEAMB0GA1UdDgQWBBRMH0V7
#> RZwTV3wbCPr8jrHzKkTC/TAfBgNVHSMEGDAWgBRMH0V7RZwTV3wbCPr8jrHzKkTC
#> /TANBgkqhkiG9w0BAQsFAAOCAgEAdLy+/KI9SklDakn+1PO1r+QpZSO+SSOJKvaG
#> bJZ/biqpYTi88nSLlr8Ep2Mu/VNxRno320pXjcGxQzzzDlLVEY3edSAXfcxwVD3o
#> +CKJ5ChRrnna5a2s58HBSQ3xAZZfzVZiScKyh/NsCe8G8UmxaCi7lic35u7jS6I8
#> 4/fzD1YWobmZ9lOzf3RZjJTI3X0Q2OhmIcbr+/B+4K+dUrRS43DYXePnVCoRy1bq
#> qfNb6rmRy3apa7dLSQj822ttpnV6Y9xFZ5jgMeRlKpG59DvwC1dUR5nPLJ5nDuiX
#> avLOq24PIQwKa4Np5OuK/hC7IRPKlB04fgq/YswAqCnFkf8a96PBm8RMMR2UUjSG
#> eO1mcf/CDtoRUnsuGhfbkGm14FUrK7s2eE989zHOUeg3+5FqULddgipaw6kntx5n
#> NW70as8CBqOOvSdWPWk2OVa+y9h494YSLC7rtGCvaEuw8VY2C4yZKw08icIhKkjM
#> wPHkKJtBwnmbXOB2eviLRMkpbAl+5TH8B6KxxTDps3Al2OuwE7lwm5lqiklaGFVq
#> R4GiG04Lc++wzsi0r8JJQ+jXHrz5S1Cf9XY2vmcfEliFWt43I9kUtKlc7D616noH
#> XRpN1WXXDovwRNYlBNYqmp5Oedv3DHoT4DjKyKehTIazyJSeFzedidCFEtRslV5j
#> i5po1DI=
#> -----END CERTIFICATE-----
#> ",""))'
```
