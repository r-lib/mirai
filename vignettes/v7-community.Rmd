...
#> [[1]]
#> [1] -0.3674240 -0.5417164 -0.4386993
#> 
#> [[2]]
#> [1] -1.624104 -2.084964  1.662856
...
If it is required to set the seed in each daemon, this should be done using an independent method and set each time random draws are required. It is also possible to set the random seed within a local execution scope to prevent the global random seed on each daemon from being affected.
