...
3. [Accessing functions during package development](#accessing-functions-during-package-development)
...
```
Note that here `environment()` captures the `...` that's used within the mirai expression.
...
#> [[1]]
#> [1]  0.99340139 -0.66103336  0.03745014
#> 
#> [[2]]
#> [1] -0.24687006  0.62359398 -0.03419501
...
### Accessing functions during package development
