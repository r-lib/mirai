...
m[]
#> [1] 4.940024 4.588510 3.609578 4.523175 4.230951
m$data
#> [1] 4.940024 4.588510 3.609578 4.523175 4.230951
```
...
m1[]
#> [1] 4.783043 2.864386 4.335620 4.604609 3.470967
```
...
#> 
#> $daemons
#> [1] "ipc:///tmp/75a31f6260200779ce4021dd"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "ipc:///tmp/ed803752fc917b21b393be1b"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.1.110:53400")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.1.110:53401",tlscert=c("-----BEGIN CERTIFICATE-----
...
#> DQEBAQUAA4ICDwAwggIKAoICAQCxVnubxv4p66SUTJy3wD7NCed805Fl0E6JI29O
#> YouANuIGy5ctD48QM+N48DwHknNKWNj0y5mpVmy/p6qlUKDK7Lnea3OpD86ov7Fg
#> nisAfaVGWHjIxvy/7UG/epyYdYoQhLXare6qbECvuy6MdZU/OVEB7T2metk2B9SK
#> I6mMkbP3C6Q5asMCLYPygc+w4enJ2eYhhYcmpsbsdRMC1ipHtNVHJKTbpg6lZKAj
#> d9cXhMYdcQxvQ6jV0Br3OQXH+E/DVXN/A1xBhurBNkfDnAa6/Uv0nrInBYwmRAuQ
#> eeLtt/Sx2EhwAX9jUpdkB8hBPSiW4bNYMTLrHqcVPjk+fPC6eUt7jrY5bAvLlc2X
#> 1zlx9Ol0sYEoUXUd1ixhCapxOkfJfQW0Plj2j3OYKMq+n5pU75nAvL3g40w6W5Ip
#> GrpHyOvLh6zj7ssX4eD7S3kG4by7mCzSk2cc0rCLhaY/ahtLf5KvNLyngzOQ+N5l
#> OOSrpZcnPrRSFYqUwPQHm//797Dg7sxhrReWNDN30xUHaer8n1wTswB9V87RDg1Q
#> YknrzOmN6uJPLOKU1DpyUrW5hsSdKRQPi9bKJYgsz4d4VvFP1em0JoEGSy7Q73OS
#> cqvnKSOQRaOzu5NbqtjJTqZZ+eyOdj2CIAECcrUpzsEC7yFngjaHonP1+YLYAOJ+
#> BssQQwIDAQABo1YwVDASBgNVHRMBAf8ECDAGAQH/AgEAMB0GA1UdDgQWBBT8T3Ak
#> MEPhayUqHcv0yIiD9fabGTAfBgNVHSMEGDAWgBT8T3AkMEPhayUqHcv0yIiD9fab
#> GTANBgkqhkiG9w0BAQsFAAOCAgEAE3HIoKGLjYtZImByOo1WIjCNk2FB29GM5Fcv
#> L31MqRFzaNoe6X1HOM4GV5P5vDlpZAFPP54ibsOfIytKa5EgISAGPcQajvEQTs0t
#> 0laOAXYdrZE4O1ZfEzgIft46XRcwfh5VvZHomezk/pT3uNgvmCUkMl2ywHAj3ptY
#> orpw+oNMhoU/dhtgbAUwJGF0ZUORiTjKUp7rFxu+DyaZ7JHOYubG51ZHJ0wdEPTp
#> dM7+PUnwZ5So5VoT0Qyq0iVwrc0tKgg8jS1TNvNqbr7kGIC0Nd+eujMzfJvz+U6G
#> NN+HGdvOT1tk5LDzYDeCY4Fdy7oQFDkpGItgdjhEm/90PQBfd7Q3h1vJHlde0Deh
#> fai4FhBmitCr0tOq3p8fcRv0V0VsM15x5TNXMK4UpvCnKAeVMQjORZ9Rh7T8pfmr
#> t6rQz5TzMlxJfMVCrfra1BCbMBCmut6lrZ9CGJwBUfTZ9yAbbytYlrSAqzoOGZLT
#> 7C3tDY86HP2aF+j8zsjBIf4d39lhCNBQl+002uCzk2kDjQvEl7Zcohwcs/LVHqFs
#> WmriJvtMYpkuCjPECQOWTFWmajsPHxadoSiXRPjXblfQDnT+udGWtn4A9zkfeTvi
#> WS/7CFfRZzLY2KRA+w5NrV117j2NMb7HZ7qtfHI1+Im08FNhWPCvZvIaQ8EluDc7
#> XCPLLdQ=
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "ipc:///tmp/c0f63277a4f5bb439fb1e0b5"
m1[]
#> [1] 46424

s2$daemons
#> [1] "ipc:///tmp/4742aeb9f6914313d23feca0"
m2[] # different to m1
#> [1] 46450
