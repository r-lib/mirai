...
m[]
#> [1] 4.498545 5.696231 4.374360 4.319025 4.662034
m$data
#> [1] 4.498545 5.696231 4.374360 4.319025 4.662034
```
...
m1[]
#> [1] 3.641819 2.877191 4.247936 3.039205 2.846181
```
...
This is slightly computationally wasteful, although with a negligible impact on performance. It does, however, guarantee the same deterministic results across runs, and regardless of the number of daemons used.
...
#> 
#> $daemons
#> [1] "ipc:///tmp/3f06e9a3f84102cbe318de89"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "ipc:///tmp/733d09795f3db0459da53953"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.3.157:52731")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.3.157:52735",tlscert=c("-----BEGIN CERTIFICATE-----
...
#> DQEBAQUAA4ICDwAwggIKAoICAQC7c9oobFuabR6CaD9M9A5MHuhH+CC2W83gNQID
#> vwEny/nEmigF559FftqbDLyIK9ORRIypwhzkwnwpVqVtQau5TyG7cgkme3vUaTSq
#> L+UqzZkURQzjyDF4ZAYPl4oK5XvX28tzciNUsSbFWxp0S8LkRXG7DLPkAv432OVr
#> mwUrzW+h8HcmgULQGNcYXQemQYtQpnmAbWDgedDfQrz5PxhXmNWR5rVFGIkGrsZa
#> ttx8FNFXnS26tYB0vowwH0FJ0ZZOF7Aq/Xi67W9/Z9FWw9peNYamAuCGlwz6SI5S
#> DnEKoBYCp/syXYCAedzJVbDH0vGp7GEhdCKocyIqvBEGeWpH/DbDZXypv6uOkcDk
#> BhxeIGRYrTm5r/P5Jb3WcnE2dqcDfbIg+T6xli5WeszwzgVxhsp0MfBwY1SCZ2fq
#> pg1INcAbXxjmqKpuNos0Ii42q7AXU6f8a2Se1PhqpIgQXqaX0Lt1N0IN1zH4GNXA
#> jrxo7iYxnjn8WDExeLhh0ARFA6TMGojzS5AxgcnhlXpYc/2TTDBVguGfcOHDxeDL
#> 5CKdzGay5sp+ab8ZUK+mEoccGtCTdsgr9yTIHH+SVW5Bi1R+2/AOm5MsNSp+hohl
#> ORvUBDOQLDRXIVhM1bg4A0MaKl6gw8KXMFQB4cvG3iyOwCs9X/fjEnqRHAxMdZC9
#> kEXybwIDAQABo1YwVDASBgNVHRMBAf8ECDAGAQH/AgEAMB0GA1UdDgQWBBRxPdUM
#> GhofmJJaa6ws9HTd7mGn+jAfBgNVHSMEGDAWgBRxPdUMGhofmJJaa6ws9HTd7mGn
#> +jANBgkqhkiG9w0BAQsFAAOCAgEAkofvJRQ9DPsbz/2lxJHSrH8s9Ilr7/S7vGLY
#> xO4hNtk+xxUsehmrG/EqtP3VeczPH/G+2CusLimgRA8ggAfscJ4q/bdtp8x7d9pq
#> Xy3k/vM1KufsoIWTxFVdQTAsEzF0IdtmOoTOL3bbQwCa1vhheOfT+nfKDjIFYyp5
#> 7nj1c5LJUpnCV5P82HdQ9jUOrHaxLFBGGrJbzM2EKnbTwEAHlj6CdgSFkRfQRwMw
#> 40YVWHpXk/qi7wPjEMnHZ4y5m9JKHEoIbZPRoSFoVauYNJmhL72DqkFsiQp0Sm7Z
#> 8A7nZalMZjC5eZiXYJu6auCmzz/Oqz76phtok3oOjgk6aQEG70tt1rf5XAJDe0nh
#> czeu0DapWOBxsCNXZEM92In0r1RLljb2rv7Omnd1NB5ZloegE81ruVLsTnAePeRv
#> NGF+noknV+14Cx/rSlI/w6MZne2wo/cJqb0Ue4MiKNbqc3PfkDqxy42JhoLgqGyg
#> Ka2oeDQVdYVw2ISeE94gSa1vHZ61rv3iv0XYCPWEq8LtHDgDxYNtIxabEuU+zIpJ
#> xw25BIORiOmvGIEGVaUTTQtTzWJIz49ZH07SLr7mQDnuKJhqGEBrWSuNsvpLs3HQ
#> Sq/EUBQoAzw4XI4aDv2N1dELOHlp2vVUQ1U81PkIgH7LH84ytvnCFRr7U5WyxAra
#> 4fFlOUg=
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "ipc:///tmp/d386f78e5fe648848e2ca1da"
m1[]
#> [1] 6680

s2$daemons
#> [1] "ipc:///tmp/003748b45cfbbc3d081d8978"
m2[] # different to m1
#> [1] 6703
