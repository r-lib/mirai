...
m[]
#> [1] 4.231572 4.688145 5.334417 4.965537 2.823690
m$data
#> [1] 4.231572 4.688145 5.334417 4.965537 2.823690
```
...
m1[]
#> [1] 4.997489 4.436307 5.628728 3.372236 2.748912
```
...
#> 
#> $daemons
#> [1] "ipc:///tmp/4837e806130a383e84d2bd6b"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "ipc:///tmp/b10f9a7f15aa39d5180aed18"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.1.77:53850")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.1.77:53854",tlscert=c("-----BEGIN CERTIFICATE-----
#> MIIFPzCCAyegAwIBAgIBATANBgkqhkiG9w0BAQsFADA3MRUwEwYDVQQDDAwxOTIu
#> MTY4LjEuNzcxETAPBgNVBAoMCE5hbm9uZXh0MQswCQYDVQQGEwJKUDAeFw0wMTAx
#> MDEwMDAwMDBaFw0zMDEyMzEyMzU5NTlaMDcxFTATBgNVBAMMDDE5Mi4xNjguMS43
#> NzERMA8GA1UECgwITmFub25leHQxCzAJBgNVBAYTAkpQMIICIjANBgkqhkiG9w0B
#> AQEFAAOCAg8AMIICCgKCAgEAwavYRfq/RC9uqIsuvPXKoywnlV0uy4nzRFM7C6/b
#> Avi7G+B9IxDL6qSBuNJjmnWrV9szfbcVDRIsYpcxqndZ8CNF0Zyswrok2wD8f+1G
#> 2sHkRoWOCjJ1rujKy7+oMtMEDNn4fB7LpP2+mv7lphJvRSBpqme894dtcDFAaWFz
#> 3GrVrl1TCQaNmt2Rj9pzHlAFJ+8qqIe8fv55cNv9xKqUK1pqdIi/HUK4V5JowQou
#> GMD0LUcnZWR7RZi5keUcMQSDZt0+1GadwNZ32FcGDlGiEzxutDPdKejDGdxbki25
#> idt8q+vDhPrFnxL8C/w9aFugq6XQXBmtxnpIeRPXVKHeMdt5toINbwYag6UOTmxA
#> Z2nWwhTA/ej/konePBhs2BI0vbGabLQQWTKmk58ELEYtRCVwAw3rvE/j/XFsQZBT
#> MAGAW2gO2DddmUxFlm1k/nHLhaAY4xNTLK3YZA4uEmlCBoSeN52tTwc5HSJNBc35
#> lBddaPMWzFnvfdgK6RdSDCSpmm5yCJmmHaCKJBQttXN/2nYrWxpDXJ65AHbiOcli
#> sniS8GZOigrF9o8W7Ow6jJlfpK4ABk/I7lYeJdpJOxnzblP1m11BBJC4fu4aZwSs
#> zAxxc0Qd0HaRiPqyb96yjFl30LdfZkARnCsdeue33WYElP0TaXA2a0c975vTzYzm
#> Rc0CAwEAAaNWMFQwEgYDVR0TAQH/BAgwBgEB/wIBADAdBgNVHQ4EFgQUi4nPISU7
#> GKyiggDAKCMFiA0vFvUwHwYDVR0jBBgwFoAUi4nPISU7GKyiggDAKCMFiA0vFvUw
#> DQYJKoZIhvcNAQELBQADggIBACM4fhiDlPV8Sv1xHgEcP984G8FwkV4gMDREL271
#> jDidcvzDc5ow8bQ7YtUp6+qqgBFK98SFI7R9qohrlcQfjNc61LNxMdMMnFAH8WZ0
#> ccm/5XRrYNw0J/WGWhe/sabYurSA/DGrnE4AYZcYtvDPi39iMSy8d6Q0nczigwO2
#> lVY4U/6t+Y5bqzGUKbah1nrpZH/KxIQeWMV5lI1sKkcYkcIZ4zUahWIbDP8gJeyd
#> FxCbAOpPRTcruRgNOlRuQ3u5UzcF2Q+s6/77HCgOU1vtSllKa4N42JxB2hegk55p
#> 5/KuDdd8pzMCp1os5wmeVFDxRfQSPXzgaRH6zT/wEIBcwDXabK6FTyuxCoVXOemq
#> /V+63Sxg3H/DU21v8hkXMp8SDG/X11COHXm5ZS15ykRmzYqNvASfaOgkIGZmJ9rN
#> cjjuZEfZVGZ2NM0lDSFHs+CRGIqvwWNTzZ8x27lxYaKUR1LadbMNuzZK0QxacPnK
#> KpxYRdNH+9li3ivVRzRZqkaVIcPeikWf1K2QWI1ejIA29mlDanX0Uaw80OjPuLw/
#> /ti5FPA5kQS2f3F8XIAKho/YVzwwgDO2Eaq4+VSnGlIiAVo9x0rUs35zKs9R1tNA
#> CN+zW4AuE4dnTyRAbUWDH91awTbGFBXQQLubvIeOGsZZxsY4Q8ZpbwZRSbmXdRUA
#> 5YK7
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "ipc:///tmp/65b542c2af008d20d211e950"
m1[]
#> [1] 13494

s2$daemons
#> [1] "ipc:///tmp/786caece09e1cdd09d2837be"
m2[] # different to m1
#> [1] 13517
