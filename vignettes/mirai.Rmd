...
``` r
m[]
#> [1] 2.749271 5.431501 4.970567 3.357711 3.322511
```
...
m[]
#> [1] 4.534921 4.553792 3.788899 2.299615 3.739956
```
...
#> 
#> $daemons
#> [1] "abstract://0c7654d6d06ca854680406e9"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "abstract://39c817ef118a5129918b83bf"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                           
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpzENoLX/file3c15453263c1\""
#> [4] "  ..@ loadable.extensions: logi TRUE"                               
#> [5] "  ..@ flags              : int 70"                                  
#> [6] "  ..@ vfs                : chr \"\""                                
#> [7] "  ..@ ref                :<environment: 0x5f241988b9a8> "           
...
launch_remote(2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://hostname:39855",dispatcher=TRUE,rs=c(10407,-743113149,-1222901080,272148617,-2039027018,-1579470401,-271808268))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://hostname:39855",dispatcher=TRUE,rs=c(10407,1046660995,1372663695,-1131713420,1037503070,-279969942,-1335263738))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://hostname:38411",dispatcher=TRUE,tls=c("-----BEGIN CERTIFICATE-----
...
#> ADCCAgoCggIBAMmToaVuA6RcEO0nRILB04wwymmHhauJt855UJwiLfoH3oKlIOot
#> 1ZGiOviGPzXSAM9T7xsNP/kFIQGjCZ2Ho/YNoQyo7XGOx/1Zcai3ryoNt7k0txLS
#> yofRlxZufKRze75kwmzHIRBJiIa6wYhe4mSu2kUqt+1xfgGTAxJw49k99Azj8+LS
#> lfwMY/KP9rMfkA2Od1uO4m/L6KEv8b4Ssyf/5PBbl7Zlfho6W0TXvr3tcLGB6m+c
#> 1ovJBy+rtKtjsHOARa5xOUsEIUFJY9pl6xt5LbSlMe7pR3pDDaXbn6lVPjUNcQAa
#> x9+A4cALWknFiJsltt9jvc6rXosPours4+XHVALRAbhKctDK7MhpekwCughlwFzx
#> hrWLGQDsIIcaXVq03uQ9Iu068lV4DGv181zJnklL8tDBJPErla4qQNtDV3EmeqCl
#> Ti1D5nQRolWFKaxZfOaLB+uPZzcfv9A3cDISsOQ2/vAli1Dm0UqfMCOLQKWOulEz
#> nH803pGEpuRg06oNIza3spNfq4zsBP+i9NqNorwq3Wibx5WBFxmUNY4dbz/lG2v+
#> QEWdCYE8/cAq3t4F10bt+hcCZFUSq7afyWjQHp9YsvDu6uGzTZPADZlcqszxJsbW
#> frS7FKZURfhusikPINi/wJ1tzuwyaxRweLNsgLQ/8ofwvIaZuvBiZLHxAgMBAAGj
#> VjBUMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYEFJD4MKRd0vyhRfqo3xEB
#> tfouccYRMB8GA1UdIwQYMBaAFJD4MKRd0vyhRfqo3xEBtfouccYRMA0GCSqGSIb3
#> DQEBCwUAA4ICAQA2+KerqEX7IVPB72I/pV8tKhju4to4A98c8Zw9wpm63BX7jlUE
#> L2d+3nsRTcbaxwp1tman1MsJ9nyLfDCOijxJ9KGiGMh3E7EwOkeMD2NiExSit9D/
#> S4xwur+FKhXCeEvZOc/RsDgB/bZOsdJtsbvR++nYoNQrlPGV52gnf7qZD+7qgbg6
#> Fe8aRLUzA1V9SWB1htlwMZvqWBXieR/BQXuyjX2SIFcNfhgZ3454u5pPlD8K1deD
#> trHNqHG1MAodTyNRe3WjJYYyK8Q7dc63Ldc6abO7pQHqq7BOtHZW+YbWwVFzItDa
#> mkt9UL2VyD/SkX007VlWjBOzxX3UxBoZvokzY+36OoY0izgHSQ577so/25jJvGqp
#> z4JVO/gcNtD6F2njKfrIc33qynhVkSmEoWA1BGtkvw15IVpF4m5u/dys2j0sFvXO
#> Ddi8Na93/8iKjYRLO8CShXd87uq9JOPu48yEg47THzS62xDA75m5KLT6RJWcqe98
#> 4uInzQoO8WEWCZZO6MVyn3v8JgvyMqlK5SuUl+Gvvu9Rliee+EhHekJSdNADb83h
#> 6ZQkRngqTcIZT6QdfIr/0m/hIfZi1ODR/HFuN2BzoowPkOCEWY/cxNDEG12MtzqK
#> Fv3DSVAMdtRYkCiP5U553jSEsUNGFVz6tuw4+X8ZBkl2IfH9IqofOXsuug==
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,912953943,-1893950804,-1469147203,369171290,-929007341,1203366712))'
```
