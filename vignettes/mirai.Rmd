...
mirai adopts a clear and explicit model for evaluation: as the mirai expression is sent to another process, it must be self-contained.
This requires that:
...
m[]
#> [1] 5.375844 4.196292 5.283457 3.248217 4.589325
m$data
#> [1] 5.375844 4.196292 5.283457 3.248217 4.589325
```
...
m1[]
#> [1] 3.712100 4.256463 4.515955 2.710346 2.524172
```
...
#> 
#> $daemons
#> [1] "abstract://8b3d23a3516cd0cf9caa1bfc"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "abstract://8fda96651ebadc8bcf285f80"
```
...
#> Warning in request(.context(envir[["sock"]]), data, send_mode = 1L, recv_mode = 1L, : 'package:stats' may not be
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://10.246.58.63:41923")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://10.246.58.63:37633",tlscert=c("-----BEGIN CERTIFICATE-----
#> MIIFPzCCAyegAwIBAgIBATANBgkqhkiG9w0BAQsFADA3MRUwEwYDVQQDDAwxMC4y
#> NDYuNTguNjMxETAPBgNVBAoMCE5hbm9uZXh0MQswCQYDVQQGEwJKUDAeFw0wMTAx
#> MDEwMDAwMDBaFw0zMDEyMzEyMzU5NTlaMDcxFTATBgNVBAMMDDEwLjI0Ni41OC42
#> MzERMA8GA1UECgwITmFub25leHQxCzAJBgNVBAYTAkpQMIICIjANBgkqhkiG9w0B
#> AQEFAAOCAg8AMIICCgKCAgEA3yflR6X47QPCteUz9pb9GDkCS32Fl9tqxvPQ2hPv
#> Uagda28hVGAdQt7EJ6tLo8DFvmmGl5bdmautEp5/3m3gK8g+r/kqmZzBqabXr/e2
#> HFJfHq9BPf3+we8QDSES0smBXhADaYrOoQbBbDhbekQY6itkzveU/VgmzZk76hCl
#> MbPJg+aHgcsLtcYzTXXw0anVQE/4fheGiOTn6oO+aL1/EgCl6zL7dj5y7gfIAFq5
#> pQ6At38MowvVzPh+gl/1gWBQ3N7Y1+yoJg2dtHPxwt05dU2przEapNuBINW2pqAC
#> +JdKX/jL052Vq2n5Diq9V4iwVoLAuyZasz3XYmOdw+OBdjjsMuqbtAADUJTHgJkB
#> 868KfGPufvCSKcurk+W570FW/83LNJ5AxZbMkImVKNLDV900XcshqLbOayTNA0m0
#> DQEpJ7QAbLvIywd2BVQftrxzDNzkorRelWxZYkxJjCFtdgE3DePsGrg4GIyIMej6
#> z5QoJn5ojfxjLyRUlr/YktmfX/6of9QPS2bBCBerPZNoHqTMbGzaxb5aCIPr+YIP
#> wsTyUmJlO+W1NSbX2yPjM9Jgn46268QIeXUEz6PId1Wz9fBL1/JW14itQIPwuJlj
#> M5F7Nh6DHhWgsu6PeS155XIU17fOx5QL5h7lyorsmBFHucpTesEVSN7MgYgp7mNp
#> S7sCAwEAAaNWMFQwEgYDVR0TAQH/BAgwBgEB/wIBADAdBgNVHQ4EFgQUgzcKldhl
#> P1tYKPnZLp+4OIiNW8swHwYDVR0jBBgwFoAUgzcKldhlP1tYKPnZLp+4OIiNW8sw
#> DQYJKoZIhvcNAQELBQADggIBAH79nToWrMFRvnXFmq9IXQQ1cNohCHXn7rKe/ndw
#> gZtETyo8T++sRcY4uixuSccIbQwqh1sG/Y7M26hPKDnod4CfT60wUXSnLh7hPbOu
#> mTAHvyjdQ5YeudMH49wbEL9yBUZKQnJh6pKbOVj2e5r+hLQGda8xhfAaw6ZMS6YH
#> YgoMBJiXktCzeA8qZe8Yc8BR2RaP3DvlHqG3v7fO0d0ma8QHgaxcgoZbOxouxj1I
#> T0C/pXvjsjHobjs9fzZHXqaFrwOR0OHWmeTKuqRqJy38CtdkyRAD0w17blTq9vXK
#> izeVc2MXnl3ruNqJ1AqphxtzvcPyxlAXyZj2zx+oJMWvTrwqqvUCPVELZs38Dn3O
#> qwsyL+1es0gZsyV+DgaJpGUHLFixsqC2qbGq4tT1jGohIexZWZtx+cZcOlUDDYNX
#> YKlJ/dWXnQDoiaiixD4LSfJpGxFMY9fzXf0RoEFA2vWG/JVl233X+a+rI2/9Z+7M
#> fmmJDOf7/hn9Poev/xMPIVTswSh2ZL7jsZttkXt7c19O4BdOOx3d70H3yXAiInZc
#> /mKZNidMcAoaXITx/ad55IriuRWMHjSgplU0/RSHG0F553d1PAcv1+rZB2lysvhO
#> Sth7hHfMzhYk2uraSy4rJ3iMTwXrUeY5ju3CTnWimU8DuF6Msc0AslHDwJwfL+8G
#> pSBK
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "abstract://4db5001f9cdc179a4b5ca1d7"
m1[]
#> [1] 10653

s2$daemons
#> [1] "abstract://a641a9dad1affb8f93c65539"
m2[] # different to m1
#> [1] 10739
...
### 9. Synchronous Daemons

`daemons(sync = TRUE)` sets synchronous daemons. This causes mirai to be evaluated as soon as they are created. This means there is no asynchronous operation, but can be useful for testing and debugging code. In particular it lets you insert a `browser()` statement inside your mirai expression and drop into an interactive browser session within the current R process.

To set synchronous daemons, specify `sync = TRUE` and optionally `.compute` and `seed`. No other arguments have any effect.
