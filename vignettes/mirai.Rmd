...
m[]
#> [1] 3.023978 5.048477 5.529588 3.682575 3.326906
m$data
#> [1] 3.023978 5.048477 5.529588 3.682575 3.326906
```
...
m1[]
#> [1] 3.616545 4.224745 4.257988 2.038878 4.246667
```
...
- The original condition classes are preserved at `$condition.class`
...
#> 
#> $daemons
#> [1] "abstract://5a41521a92ecce7c6da37e2a"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "abstract://efb51a28d1adc92d40ac97ff"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.1.71:39137")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.1.71:42233",tlscert=c("-----BEGIN CERTIFICATE-----
...
#> AQEFAAOCAg8AMIICCgKCAgEApWZ1HLVdCA+sS56menq338PSAnKfAIFZOVunhLYT
#> NaiC5gaXAY32gfuoSa6JH2y/UWpCqO+6PCoNPwaqpskEZER75Gd9D4n5Vl7lY3w9
#> cgwEASwUNdQ4AOVgNG01XtlslyNW0bx0CVJdB/HuyxFNB+v3kEgIKFKKE/DkLjbM
#> dtJ0qy2KTLCuuk9MsNuwHrfOQdLSra3sxx5Xsy9/8HJ0vrfG0tSJSX8GgIMLucK+
#> oaROToNhlt4fCDLW2BkS9FazUtTSjYD4BlmaRjBd2i+pQsEu++ipp8t6Jy01o9TN
#> KCk2REWp+m0BsinrLFqVJ6OfmpIQCZ1qiJZJ4x+qNEmt7nCTFfkycsHeSL51vU3p
#> oEHZRY6iCQCAYFH9F/S7sLIthUMsGWjEpeyCkpDcT3ekdBm2ujUyXhcQPYpDXFcR
#> lWAo6jn03YRaZ+JFpc7nKzsdJqzvuwG5EeK1pzYIgdbeD+teOxyjKj2EuM6RS/3T
#> 0B+2Lth3U/Ggi8U/stx9IvIq1TjuN52dUVzTRbTYtE0IvsD5hX+ZEUCTod6W3sIC
#> 6JEafx3YYvqwkDV7WzQO9XMwnBn0TD+BU6J4m1n8VShJwo7Uxi+XCMEB6vd7H86+
#> KSRX0vnB+yAHBPMpCWKfoMVyB/WtZXdVgwF1W2AGkRSml3FGY6hAEvXvQr+zzKOK
#> 4L0CAwEAAaNWMFQwEgYDVR0TAQH/BAgwBgEB/wIBADAdBgNVHQ4EFgQUDM2WwG2H
#> 5D0G71W0ciYjUcK6AjIwHwYDVR0jBBgwFoAUDM2WwG2H5D0G71W0ciYjUcK6AjIw
#> DQYJKoZIhvcNAQELBQADggIBADr20hRGgiU50nMwScjPJfUeeaRdTFjkfNlLwS0y
#> Qx/Cjol06uQMvDoi8XRRBWrRNSgSz1fm4ZzZD/PLD+P+5p0ocBQkw2Gp0MjfJnSv
#> sBl3tHLvDgITfx0OwiPGEwgT8ffz9zsFrslj508K2iWpdG7rxcgZEY6ST8C0OY7W
#> 0eDmpKfQ7lJQIoE0gqqgjoLADf4SLeuzUEVrTdcKxJowQzbX6xBq4nva9pjZUY3b
#> yRPXsuV7FunsZtDo4G48gkDgBQCRNfhZWDyR0K0AFDpsRoSSgFTtv4DUuOJWj+2g
#> xa/lDDODGRoy3TyhcYHEJpqild3bEmck5Ofz8nuvP/N07AYNPrJap2zhWMhp8PhB
#> nkI4F0Gec1dnbPEhEJHBgMIADooeuFeZx6ZgxTvGvVl8V34sXg/WoTlcZOrN9rlT
#> 5XLBoX+B/QHenn5jDjfImr714nTHRxlcFWH7m0ZjkmEiTGKFMUJ4JBl14F10iszm
#> n3sOAV8Bvqv7NVquTQPoFBMOUc91203owtxV/UzooFxgIXvIPct4orUIp7A5rwep
#> ifXxDaFdUPUL2Cjg7lAwhKKCRVevJdIUL/zxxWyQ2D1/BkhL/RzjILNx+fBsnfQa
#> bizla80aaWgKB4rXQUBaFNB5/dIbc2kqodi78aHaEgDfyk+pezOOVBAX6TkxFxig
#> gcAy
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "abstract://cd494863f903c9f1184da094"
m1[]
#> [1] 9284

s2$daemons
#> [1] "abstract://88cc382873f68069cdb463de"
m2[] # different to m1
#> [1] 9370
