...
``` r
m[]
#> [1] 3.755713 4.727127 5.559385 2.677649 3.198113
```
...
m[]
#> [1] 5.118164 3.854162 3.053333 5.220416 4.246678
```
...
#> 
#> $daemons
#> [1] "abstract://76abdc5abf6b9bec69537c23"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "abstract://d0756ef55237a207eb0315d1"
```
...
#> [2] "  ..@ ptr                :<externalptr> "                          
#> [3] "  ..@ dbname             : chr \"/tmp/RtmpI87Rnq/file1fb6e276d2\"" 
#> [4] "  ..@ loadable.extensions: logi TRUE"                              
#> [5] "  ..@ flags              : int 70"                                 
#> [6] "  ..@ vfs                : chr \"\""                               
#> [7] "  ..@ ref                :<environment: 0x634b6e5a0ca0> "          
...
launch_remote(2)
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.1.71:32949",dispatcher=TRUE,rs=c(10407,-1023089686,1315398755,1833396808,-1931623511,-735165610,-2050143777))'
#> 
#> [2]
#> Rscript -e 'mirai::daemon("tcp://192.168.1.71:32949",dispatcher=TRUE,rs=c(10407,262592205,1883855057,2079754486,1834751520,-297263945,-2060389285))'
daemons(0)
#> [1] 0
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.1.71:39271",dispatcher=TRUE,tls=c("-----BEGIN CERTIFICATE-----
...
#> AQEFAAOCAg8AMIICCgKCAgEAkDST3GKOAoGm73OrB/WptiA4Mc+fnl6X+oo8K6dp
#> O70Q637lw+x+f+tXlCOh1D/JHL2gcLKGyzyYLUhYM1+q6rfmk6TJjVXw/vaE4LOL
#> 8w4eNuTaUhRLG3+EluIDGfm+SIPWFrAhj6V2R+AyK4MALCEtJYuJk1ZRllgbhbFS
#> 0YHRCMP7CyT6hKXr20TYDgENie3oD8mNROoq1a81+uq/YdVhvY9nuUrFHrsymxtl
#> SiMK2ZzEpGmWeOxzd1yp15O8pqJC51slLKGyLvDKq9s97ibxRIGD/20y22sBJXDz
#> CQWKy5+tI6NidQENKVzqRsVI+QFf7pT5ncJxJlI6k/KoqS/AAp3kpfyD20zVydeB
#> PmzEZxxZDyAINPUeEAXTUQp8ICRcrk4+nftIwW1AMYgDaMIlClDD1ryxJcxNRis3
#> mvIrBCdrxTIe5RZcLzaMcNILkCNAdx2uRy4f5Awd68XiZSH2s6TDd2ejxan2OsrN
#> ln2lR/FyD2Z+DUWIB6ykNdUao79vjzyjPCsQOjr8oN3zihAojT0IeAc/Q8jMVxCq
#> WryH7rNM9Ls2roNPV52KfE6GIE8HueS1gvao2HDcblyKFhJ7p/pXhhvKyR1ze01C
#> uj9Amqn5Sm/eMbxoJNTCrWMXIQ+BfKM/LRhp7sOESVOES5crHnJEzop3XOrhJizK
#> 8SkCAwEAAaNWMFQwEgYDVR0TAQH/BAgwBgEB/wIBADAdBgNVHQ4EFgQUuQgIjMIH
#> zvTnmiGbYTK8wj2G9JswHwYDVR0jBBgwFoAUuQgIjMIHzvTnmiGbYTK8wj2G9Jsw
#> DQYJKoZIhvcNAQELBQADggIBACFdxfirPmmGy+aWvSdeebKMpL64v0+QzzgBHLMa
#> 7tJYz2IlenBw+q3pNoH0xo2sS+nCFdu/iwLxU6CkY6bNyqMcIaXn+ZtaiNoelId+
#> wcTPIVUZcnJFz/5/OdiJtM+7cUKYUDOUZ8X2blBiDML4+hmsR+xkOk/lKF3w6uzi
#> WYWecXswp9mcnG1B2EySqXMPJ/CFMt+0kOdx2jJ8av5Cdp7rn1bqarwX+msOmXhh
#> 6tmprqYSWNYfnYLk6Y+Wtme680whFa//BF0k3mHtiEgX3cnUe8oz3fv+Zk57aDcA
#> ABZ8EAqViMTp6w2tz0Ftv+pVA8ypE+ZQrWGzGxFPMRJHbW8JWcbQdJ/2/qQC9myt
#> NODn5mX2b4LRNTXxrFBqBNDUIRjr06r+Nch2thDNfER7af+/MpAKAR9G98yxS2oF
#> MiMzEFgcuyxMxLUErxPHJRzkyl2M+VBOB9C+H6cVyZX/GgKwL7gP7t+qts7uCwih
#> naVw8x97t7FeEAX8A9SuvbFbMH3YKsTCUHBkbG11FgqxRUsd4T5kdcwQ3W3s2Co1
#> UrH5pUt8KjjhpL/O5boJKtrKHoswS1C/9KA7MSw5erdVRT4shc0p7pqI8xmTf5gW
#> F0XK00dfgy/X2lzVMfSG8Hil5smm4Yc1qoW1Xdxu+EeL7hWdJTe4HU3aUzIPNQJO
#> GKqG
#> -----END CERTIFICATE-----
#> ",""),rs=c(10407,-1591818328,1567713673,-4819018,-2132272449,502799860,-1222025115))'
```
