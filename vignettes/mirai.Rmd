...
collect_mirai(m)
#> [1] 3.474679 3.414037 5.796098 5.301080 4.659532
m[]
#> [1] 3.474679 3.414037 5.796098 5.301080 4.659532
```
...
m1[]
#> [1] 3.538061 4.139862 5.024287 3.983760 4.743657
m2[]
#> [1] 4.106914 2.267360 4.363798 3.862909 4.778226
```
...
#> 
#> $daemons
#> [1] "ipc:///tmp/cf507126c6020c81d8eb2ae3"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "ipc:///tmp/3de2577a2c4d0113f4544d5f"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://10.216.61.193:50600")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://10.216.61.193:50604",tlscert=c("-----BEGIN CERTIFICATE-----
#> MIIFQTCCAymgAwIBAgIBATANBgkqhkiG9w0BAQsFADA4MRYwFAYDVQQDDA0xMC4y
#> MTYuNjEuMTkzMREwDwYDVQQKDAhOYW5vbmV4dDELMAkGA1UEBhMCSlAwHhcNMDEw
#> MTAxMDAwMDAwWhcNMzAxMjMxMjM1OTU5WjA4MRYwFAYDVQQDDA0xMC4yMTYuNjEu
#> MTkzMREwDwYDVQQKDAhOYW5vbmV4dDELMAkGA1UEBhMCSlAwggIiMA0GCSqGSIb3
#> DQEBAQUAA4ICDwAwggIKAoICAQC1fx+QM9/I9H1Rwlm75WG2uf9HoFINF3XkHkno
#> Ga0OyeHT0FYUA6M3InH041IcPBOW4p0SLQcMYcKc1bg/fpfRq7PQBTLocmTC3x/7
#> VJOGrRGqlp8PM72RJPNceAOY7ifRot9wykh3p5tJAaSlft5fywHPkMVToBXrCfZm
#> 5vbNcaDnWFsofiJzQKF5XhfxeWTogJ1xANTQ8MPKfBiRWEkjx7/HeR0E+pGP2ovb
#> cdP6n2xynfgICVL9691mLnhDM4sU77zyXxf/RoITTt6wbRUsliTM5+9+pFI0YDaB
#> vroslHoUsMiEcH/nQGxwTl/3etL5E9pdXP/0WE35kc12UpwnAyycBzEu/iROLVts
#> iw8V5U5aFX5XDYqdMWeQ3CtgqvVQHWCEgJbL9TDbylS3E10B5VTQR+k5XWeB4VSJ
#> E9gvzO45VGsSXIHodVA+CNWpClPlYrTWUjlim+adONpkUANGMYTiaYtMNP87l1eE
#> k9Vl+LZbC2jvkCpR6zOkVpcKNPOvmYdL8qmd7N6EBtbW7Sf5Rz3r91uai2fxhhmA
#> ZZY6UkwMFDvsEKCPCZon28oGfC/csebshpFX5OzjQTxFBwfdS5LtrOpgtG7l4TBa
#> T9pPhEEO57tCzRfwWUwbHNYT+eSBJRBrH1V6w2REUWirsdS0FkkH+a1THMdTYCDQ
#> I7O68QIDAQABo1YwVDASBgNVHRMBAf8ECDAGAQH/AgEAMB0GA1UdDgQWBBQcz1Qm
#> 8oJcE/upHHw0f0UxveUVGTAfBgNVHSMEGDAWgBQcz1Qm8oJcE/upHHw0f0UxveUV
#> GTANBgkqhkiG9w0BAQsFAAOCAgEAI4fN9102LwJBNRolMxX2HMy/4NiXJQG0Ied5
#> Fydbu9EpyXWI9MC4/Ww2F9p1aEi5ecY7IIEL47XY5f97XGPwwX0+C1HYZRx7dGmt
#> oowZx9WeUpmlkGDd/fZC9XYY+QdItsSvypHSR7sfqAyANHW15a2iB74O5X7WS0Lc
#> T0eR+28lgk+LykUG09pdWAv3P8IPzRZiiLYCsCmnUmb0Ot5EiWy0kpgzvw+v40Du
#> IcugIuObRUmSYubJngO1KlUHE/enzSPgMQEbDZVFbDBuFucm+MjyfwrRS8QNehqI
#> brSVGi2JSXG7HU27uASbdL7rG/PK+Cdx/5m4rPRj7DNZh2EZc/Ithdy6xvNMZMm0
#> WNRrSMvamW6wgEir6F5j5o+1bRdi2DtdPoJ1SSv5hyW+s1/rkXdYLKEvo2KixodB
#> pyLKgteB5UksLFwAOLCV8YORP0mUXtNaKVaUusugu0ukqeIil0jUk8uG8TsOpVty
#> A/M4tXVVUNRgNKDReq0BnkYGVrkctEVwLOOhQsa7DXXtXKhplTqoh5qjgvj2WilM
#> oTL3PQqWrSkj2x+VKEL/wuGe/uPQ7XH8SRwMzAzdtSztZ0CP29XK5wEErk6/Zk4H
#> idC9HKeEHFvNnXHfHQRQl73yxZm0Q3bEeuDt9/zmFlhPnx23sjw/7gibCE4wNFU0
#> jYM7A04=
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "ipc:///tmp/aa3b69723b5be990e15046cc"
m1[]
#> [1] 2583

s2$daemons
#> [1] "ipc:///tmp/f0d4691f706dedc2373845c3"
m2[] # different to m1
#> [1] 2606
