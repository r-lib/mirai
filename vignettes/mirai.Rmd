...
collect_mirai(m)
#> [1] 4.468199 3.547966 4.872272 3.316614 3.421524
m[]
#> [1] 4.468199 3.547966 4.872272 3.316614 3.421524
```
...
m1[]
#> [1] 3.143013 3.831089 4.431946 2.899070 5.094089
m2[]
#> [1] 5.872291 4.347387 3.378978 3.333138 3.602079
```
...
#> 
#> $daemons
#> [1] "ipc:///tmp/8579be6b6cd9604ba326e434"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "ipc:///tmp/503881fba1b259fcb9c8c47a"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://10.216.61.129:52341")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://10.216.61.129:52345",tlscert=c("-----BEGIN CERTIFICATE-----
#> MIIFQTCCAymgAwIBAgIBATANBgkqhkiG9w0BAQsFADA4MRYwFAYDVQQDDA0xMC4y
#> MTYuNjEuMTI5MREwDwYDVQQKDAhOYW5vbmV4dDELMAkGA1UEBhMCSlAwHhcNMDEw
#> MTAxMDAwMDAwWhcNMzAxMjMxMjM1OTU5WjA4MRYwFAYDVQQDDA0xMC4yMTYuNjEu
#> MTI5MREwDwYDVQQKDAhOYW5vbmV4dDELMAkGA1UEBhMCSlAwggIiMA0GCSqGSIb3
#> DQEBAQUAA4ICDwAwggIKAoICAQCkYYHfVTJ75WwwDF7X3E9fpUwcLSQqqc4GwDyz
#> /03Nxzq2AZqvoOw69rEE+ofBQW8lcb6bcz2ykWe7v6hYyqPjQNpBXhrkngmQblrY
#> xhSq+LUlM9SCriz3Ip1s0kDoZCyBdekm3b3ZKk3Dny7se41isgGR/0cWbciCSnwp
#> 0+jjxs4i+od9Ec6kIRsx6Lv6YCxZGkOE4p2yYKOBOdhOyiEOKm1qDoJjcttmEiAM
#> fmvhUL0JT9SuolW05qwbSioQcwstIxa8fFpDFZ359DlcJDTuJoc4GHDpj6epNTxA
#> ybqEFVfVdvyuxwWNf/Gd2NMpW65yb2Tw0GS+gg4zrCqtjeHsaCNU/4Pa+5ZGmAQV
#> Dw+cJqbpX9h0DbVSijfs0PXUrXKgzP0+SI6rakbNoDrOzj2Hm0gu0OGgM5BMiuWT
#> dhlRLZoZFVcp6X0PodYKF3ww2hP+chj69CfpTBorU6mq8JhO7Rm1bZ2T1lDP+Qma
#> Jt3LCSDMId0ubG2kg7p5CUXgI6f1tzepPKTUz2x3/pEG4n9KHBaixdD0Z60FJbw8
#> +nN9TB7BAs4BxUHuuIC3njBwahc6Magymxbv4uO8e8gIQGPrVJEWcUzPi1ZKROle
#> dQGJfQO0pam+PihSn2Umk5u2bne69SUbaJ/+2mYZ2LhIJpTBiKNkEEoX5T07hJXX
#> 4YJuVwIDAQABo1YwVDASBgNVHRMBAf8ECDAGAQH/AgEAMB0GA1UdDgQWBBS1N29X
#> Vk+Lzaozgeouvm5f8/pHkjAfBgNVHSMEGDAWgBS1N29XVk+Lzaozgeouvm5f8/pH
#> kjANBgkqhkiG9w0BAQsFAAOCAgEATrDEMxLe3nD4VWSwqfb7kW8vQBl/WowtYWdz
#> 6ym19Ot1FdUU4Tw/j60Vnm/QYhWob5IhFp8SRx+idEVZO6ruwyeDVIUtT0/0p4x6
#> HvmrxJK3MRhTLho4bUVH1JUdFiMS0+EHQ29rwqpWvEVvoyn2AkAzr8NexIBGW2LP
#> gdPeDN5Secq0UYt/bmRzs0LcQoLhZ4FLJ1wQ053MlglUNTSta9eAJlwXwN6cSza5
#> pIrLKPlU0ukLeAZMmrrw+vPDYTsFlFzxlYgEpNiDqKhvUgMTdveh9UOBi5yTWMnH
#> gVuNDZwiW2q4coAklLF771zabWBYMTUP574UU2OZgkdCF9R5DmhbrqOX4ncAyztN
#> xuF7TsIpM/5gnNNaP9pXoKMpZbMux+z4jRpPDd7nXonbDmUQYrWoNbxjUAifkEvz
#> nZM2MD40EhHnUMRpbuL7WUDExF3V3Tu8PVRx0Ssy12kx/4uyxL09rpzNEVLMB+BD
#> S6E8GvrLQ6utthQnrLAI+Dqkh/zJcw5LMh8YH18LptRwot/Ucy4GnVbZzYI229BE
#> HuiGlFi2YIXDZuqrcborLfufwVZp/O4slpu2DuzM3sTAkZX4kDLTSFY0X5WdhvEs
#> GO9r4P3Ssm0zo/Nz6lsH1bf1R3l2wuSHXT/XOVhqXndT14eXun2HOEkOsA/ZsVJn
#> Wb1hYUE=
#> -----END CERTIFICATE-----
#> ",""))'
```
...
#> 
#> $daemons
#> [1] "ipc:///tmp/e1584d5e097005f01d734e73"
#> 
#> $mirai
#>  awaiting executing completed 
#>         0         0         0
...
#> 
#> $daemons
#> [1] "ipc:///tmp/919b8c301dbf682f98c3337e"
#> 
#> $mirai
#>  awaiting executing completed 
#>         0         0         0
