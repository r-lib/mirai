...
m[]
#> [1] 5.809552 4.934121 3.966212 4.442888 3.643468
m$data
#> [1] 5.809552 4.934121 3.966212 4.442888 3.643468
```
...
m1[]
#> [1] 3.523121 4.522287 3.890605 5.237182 4.616812
```
...
#> 
#> $daemons
#> [1] "abstract://713c553ca41824332271f4f1"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "abstract://07d3a9544118ee8855b33560"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://10.246.58.63:46005")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://10.246.58.63:40431",tlscert=c("-----BEGIN CERTIFICATE-----
...
#> AQEFAAOCAg8AMIICCgKCAgEAxHDoAqsfps6Li8LQ3CkM2ZHzmNquDfAz8XggJfFp
#> uFFL2ZkCgDumP4e0aYegcak2lskeGDLX5eGEZ7CHt5ivbHA5jfcdW0Rj8dpw6LGU
#> oguohD/NW8nGh6JhtzufCetnlbGETcCe6o9idG8MghyfmgN3VirRlL6iyVTyS0do
#> NadFtoy2yIXuv2BqldDGNsUAjjTTXrFZiJAifDDH5Bv3fQEWO11+Az8TsxlWXp6j
#> UBh0cSUjpysRWLVKBsx0W+SALvk+JPG7933aLZUFi0eq+9GbT1VGRmUOoshxSnJ2
#> Sy5k3gY6BoTOcpJQhtNTY104BdFKhD2eicGY0wSQ6tr3Rc41jtfFqScFUYu+vEYH
#> IQtJn/goxEyfwt47ZbMkOxDOMZHPEJGCqxnSQSMYY3tDWHK1XfZDIgihStNSbuxB
#> pJiAwqYbw/co4i+56V2up6sBZ5LhtqTd1xVYlYZB4FoOwZE+EcfqhI4G5+J5m2F4
#> H96WDhIGBEGNkh50iz3MckyTHvvYTae6JmzMuQLSEYgcXx09HRY2j6Y+aUW9ifHH
#> GEDDSot0PtcWvtv7TyO/gu9WwURN7WmWW3rhRRTBTDdI5fe58ADzRhbI3dbaDNtw
#> 7/USHHcNacTtc+gTm8YNLSJT+OgyOHshaEnIq9wUa77Cy84nKv1I5m3vkaFy5QEf
#> qg0CAwEAAaNWMFQwEgYDVR0TAQH/BAgwBgEB/wIBADAdBgNVHQ4EFgQUmXb91oCK
#> 0PE8nOTcWLxh4Ckp5wkwHwYDVR0jBBgwFoAUmXb91oCK0PE8nOTcWLxh4Ckp5wkw
#> DQYJKoZIhvcNAQELBQADggIBAB3O8+il2WMoZaHa+ZplVpGQA1IIYmxCX2o9JeRj
#> RUf3mbZtOq27yZ8R3mHwH11wKoouhhCfjCxT1SlPw1m3l/nHCXCOED6NupoT4Vc3
#> lBcnu9IE5hJSCt4Km5Gcsk4XVoWgi3MZ4HTInQFjvJJr09Q7iIYd49XMOUrXs3vJ
#> 6FX7z9Lq83Nequ9gVOOAuO4QR3MJwUCDe/DWxdG5mriPn6HFw00ToGNxh7C7b6Ir
#> FSYPnb2uAqAGV7hEAjaqELDFxB3hduc/TsDQI80c/2geb+Mgk9rZRrOlCrtr36nO
#> 3YuXJTeUOKYvjNjhpT4uf9GlDWzdC+XL/kjIaTKixY36/7bOmkHyBnmRu1CdKOz4
#> qABncYxRvevhrHM0QcgAksmrnmx6NlHdhBw+lhJy1AlW3jBeKmGTVmLVeKDwHSZy
#> Ub8WhENuqk5mWYldY4PPVbtpk2GiqzoeVxtWMLo+sfixQAgHvvcpFkOLg1peRpRz
#> bWjgfOgX7nf3xCB+82yBBbvnXKQZcLHqyKUloFsY1B+RTyIzz0Y2XBoNTuSnWMUT
#> yIHF5I6M+vFtMG85iGtd57TYgIYbLl2h9Q/Rgec902teGH5kP4e+mdRa9a3LyiaC
#> FENDWzC7iyFgNjO36FLbOzbk3SHib+o9kxSXofwW/pBBBeGsUTywFmoUdXGYPfXq
#> B7ZS
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "abstract://061c69e4842e1b08301082ba"
m1[]
#> [1] 46574

s2$daemons
#> [1] "abstract://cd2740f3836165c9e846c0f1"
m2[] # different to m1
#> [1] 46660
...
### 9. Synchronous Compute Profiles

`daemons(sync = TRUE)` creates a synchronous compute profile. This causes mirai to be evaluated before they return, and means that there is no asynchronous operation. This can, however, be useful for testing and debugging purposes. In particular, it lets you insert a `browser()` statement inside your mirai expression and drop into an interactive browser session.
