...
collect_mirai(m)
#> [1] 3.942875 4.289118 2.962460 5.030996 3.539577
m[]
#> [1] 3.942875 4.289118 2.962460 5.030996 3.539577
```
...
m1[]
#> [1] 5.982976 4.073972 5.252413 3.678020 4.666733
m2[]
#> [1] 4.484357 2.534563 4.146900 3.740590 3.838087
```
...
#> 
#> $daemons
#> [1] "ipc:///tmp/63f8b67d532f9262f7470b74"
#> 
#> $mirai
...
#> 
#> $daemons
#> [1] "ipc:///tmp/11d19f3e6713e07237cbb1df"
```
...
launch_remote()
#> [1]
#> Rscript -e 'mirai::daemon("tcp://192.168.3.157:62582")'
daemons(0)
```
...
launch_remote(1)
#> [1]
#> Rscript -e 'mirai::daemon("tls+tcp://192.168.3.157:62586",tlscert=c("-----BEGIN CERTIFICATE-----
...
#> DQEBAQUAA4ICDwAwggIKAoICAQDNx4NwAHIwc4fVG48FcW+gaH7afbI4pU+Cofua
#> NeuFql6/8xNuASC2pUt9xHa9UaGUn0bQ2WxzHak/Kw5xdKKGOXvY2wmBmCqLdwlO
#> x4uMHgeGusRrhNODiX92P8VKnzN+3rjykVH3t6+N2Ver248jpsUV/zMjJJmbKPCY
#> yEPHrHmBkhR73UlsTDfWAo721DuJRMUhKhXf5uQejeSWsNfI4jYlQUy/fNRFq6QX
#> Y+AeVbMyffACw4lF1PHd4ych/cjcdRzPTR0k4nefk/NI4cgyrRorhsabwXOeJu3G
#> NkH0huASykQZdtkPA70ACfymO/Gm4T9OLIbiqGw25kSpUvA7xJnCY1dygiS/BpEd
#> 0p/CgWyDhUm0oJGBPAVPIDmN/p70yGe2m95KrFRU25xJu3c+1TUU+9t90Y0kCjVG
#> V7BahgZZ9LLl4HrlDOv+tRns66lbMP1ur9p9llIIZ2lOrS4pwIaFI+YmhcoPcVqP
#> pCiQ7WwI30GZ95WsfAAAcVqXcEeEbX8AObw4ErIuEj8QpxxRARrUKZfhc9xeLx47
#> ab2078pPHZfN26Gv4HKk8fd4oyDt+YU6NnslBDCR0Gs+mpKQyfUN8fHKdAQaJT1N
#> 0xvAswAFwRuoWK95uK/2xtstZTjKD2TdvDGJMNk3S2F3+nmJD3JXfsvsZWz3eRuH
#> f63DDQIDAQABo1YwVDASBgNVHRMBAf8ECDAGAQH/AgEAMB0GA1UdDgQWBBRH9nkG
#> CcbfvGzLpUgDOPYbOVMxWDAfBgNVHSMEGDAWgBRH9nkGCcbfvGzLpUgDOPYbOVMx
#> WDANBgkqhkiG9w0BAQsFAAOCAgEAq9OK85O2pAUaaKPso597u9FoSpT/WpuC8vya
#> tiqNYP3Oe/niNIVq3JiUx2urPjujpChHSSCOLOBgRWqeDpNZkRCJ9hNrs/dQ107Z
#> yrdQ/q5+NPyfXAB+jw59i74hd2gRvz0yJ9XDFQmn8bwnLeC9DGaAPkn+2dfmSjKj
#> T+D6Li+R5gccTq2TwbimXonER8PWy64kzSVeiMt6kFjIG6w/LmWOGH1iNAj/veht
#> 0whBfwWmeE2rl+Y5JGRZbDu0cWY96X26ARS7YTnvhJnaWnNxzI/AjjgsvLSJKAfr
#> Z99N3B+jAv93hT1Dj/+FCECkPWnfchNKqoz1YlwV6YfCb+60qL8GfewYzmp6yoZO
#> FJngORsfn9vdG8Le1t72W4YEvv/sZpkk5bmZzCb7BbyoW1qQFsOaVDXR3ELnvT2e
#> 9ytBziDx/r0PnxRY1UX/QmymPv7U26uC7cb1DsdjL2etN1WXY53dQ9i9z9/BxcFn
#> WJ/9UoOHkiR4Mgjq5jIja2SWaqxJFX0eHiou494HdJS9f0A1br04U2TunkdP4RH0
#> HpA5kIdEwbuzRbo5YM1HVIekAJo8BCYZBZPAqT5x6bxHv/zr6YrRSBNq+WRacyU/
#> 0vkzLUN09dyrSqua4Nypv7Xupp4jjL9DajRVZz47Gxa1urJJOe0M8TIHERTwWVCH
#> EZmMfOs=
#> -----END CERTIFICATE-----
#> ",""))'
```
...
s1$daemons
#> [1] "ipc:///tmp/7014f7402a6f0ec29a347213"
m1[]
#> [1] 39954

s2$daemons
#> [1] "ipc:///tmp/f9068f0d28881f33e6d0d3ee"
m2[] # different to m1
#> [1] 39977
