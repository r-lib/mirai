...
Sys.time() - start
#> Time difference of 2.046158 secs
later::run_now()
r
#> [1] 50005000
daemons(0)
...
collect_aio(res)
#> [[1]]
#> [1] "{\"time\":[\"2025-07-15 11:09:24\"],\"msg\":[\"1\"],\"pid\":[4692]}"
#> 
#> [[2]]
#> [1] "{\"time\":[\"2025-07-15 11:09:25\"],\"msg\":[\"2\"],\"pid\":[4694]}"
#> 
#> [[3]]
#> [1] "{\"time\":[\"2025-07-15 11:09:25\"],\"msg\":[\"3\"],\"pid\":[4704]}"
#> 
#> [[4]]
#> [1] "{\"time\":[\"2025-07-15 11:09:25\"],\"msg\":[\"4\"],\"pid\":[4710]}"
#> 
#> [[5]]
#> [1] "{\"time\":[\"2025-07-15 11:09:25\"],\"msg\":[\"5\"],\"pid\":[4692]}"
#> 
#> [[6]]
#> [1] "{\"time\":[\"2025-07-15 11:09:26\"],\"msg\":[\"6\"],\"pid\":[4694]}"
#> 
#> [[7]]
#> [1] "{\"time\":[\"2025-07-15 11:09:26\"],\"msg\":[\"7\"],\"pid\":[4710]}"
#> 
#> [[8]]
#> [1] "{\"time\":[\"2025-07-15 11:09:26\"],\"msg\":[\"8\"],\"pid\":[4704]}"
...
collect_aio(res)
#> [[1]]
#> [1] "{\"time\":[\"2025-07-15 11:09:29\"],\"msg\":[\"1\"],\"pid\":[4768]}"
#> 
#> [[2]]
#> [1] "{\"time\":[\"2025-07-15 11:09:29\"],\"msg\":[\"2\"],\"pid\":[4770]}"
#> 
#> [[3]]
#> [1] "{\"time\":[\"2025-07-15 11:09:29\"],\"msg\":[\"3\"],\"pid\":[4776]}"
#> 
#> [[4]]
#> [1] "{\"time\":[\"2025-07-15 11:09:30\"],\"msg\":[\"4\"],\"pid\":[4786]}"
#> 
#> [[5]]
#> [1] "{\"time\":[\"2025-07-15 11:09:30\"],\"msg\":[\"5\"],\"pid\":[4770]}"
#> 
#> [[6]]
#> [1] "{\"time\":[\"2025-07-15 11:09:29\"],\"msg\":[\"6\"],\"pid\":[4786]}"
#> 
#> [[7]]
#> [1] "{\"time\":[\"2025-07-15 11:09:30\"],\"msg\":[\"7\"],\"pid\":[4776]}"
#> 
#> [[8]]
#> [1] "{\"time\":[\"2025-07-15 11:09:30\"],\"msg\":[\"8\"],\"pid\":[4768]}"
