...
#'   e.g. 'tcp://10.75.37.40:5555'. Specify a URL with the scheme 'tls+tcp://'
#'   to use secure TLS connections.
#' @param remote (specify to launch remote nodes) a remote launch configuration
#'   generated by [ssh_config()], [cluster_config()] or [remote_config()]. If
