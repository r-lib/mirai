...
#'   .dispatcher_try_gate .dispatcher_wait handler http_server ip_addr
#'   is_error_value .keep listen .mark mclock monitor msleep ncurl nng_error
#'   opt opt<- parse_url pipe_id pipe_notify race_aio random reap recv recv_aio
