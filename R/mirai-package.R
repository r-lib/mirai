...
#' communications or TCP/IP secured by TLS. Launch remote resources via SSH or
#' cluster managers for distributed computing. The queued architecture scales to
#' millions of tasks over thousands of processes, requiring no storage on the
#' file system. Innovative features include event-driven promises, asynchronous
