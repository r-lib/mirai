...
* `daemons()` now supports when synchronization between host / dispatcher or dispatcher / daemons exceeds 10s. This is particularly relevant for HPC setups (thanks @sebffischer, #275).
